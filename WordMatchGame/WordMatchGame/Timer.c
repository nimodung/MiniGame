...
volatile char start_flag, speakout_flag, next_beat_flag = 1, time_print_flag =1, FND_reflash_flag =1, time_reset_flag = 1;		
volatile int msec, music_i, show_time;				
volatile char i, sec, min, hour;			
